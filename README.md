...
- **Back-End**: Firebase, APIs RESTful, GraphQL
- **Banco de Dados**: Firebase Firestore, Firebase Realtime Database
- **Ferramentas de Desenvolvimento**: Git, GitHub, VS Code, Android Studio
- **Metodologias**: Scrum, Kanban, Desenvolvimento Ágil
- **Outros**: Testes unitários, integração, debugging, design de UI/UX, otimização de desempenho, integração com APIs externas
